...
?>
    ...
    <section class="content" id="app" v-cloak>
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">
            ...
            <a class="btn btn-app" href="inicio.php?accion=instancias_inactivas" style="background-color: grey; color: white;">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de Instancias Inactivas</h3>
  ...
  var app = new Vue({ 
    ...
    methods: {
      ...
      cargarInstancias: function () {
        axios.get('<?= $axios_url ?>api/instancias_api.php?accion=listado_inactivas')
