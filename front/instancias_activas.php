      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">
            ...
            <a class="btn btn-app" href="inicio.php?accion=instancias_activas" style="background-color: grey; color: white;">
  ...
  var app = new Vue({ 
    ...
    methods: {
      ...
      cargarInstancias: function () {
        axios.get('<?= $axios_url ?>api/instancias_api.php?accion=listado_activas')
